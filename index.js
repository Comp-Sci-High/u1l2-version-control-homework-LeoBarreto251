...
let versionControlExplanation = "It tracks your changes and checkpoints in programming projects";
...
// Write your answer as a string and store it in the variable below:
let gitRepoExplanation = "A git repository stores code in the repo which tracks code history";
...
let versionControlBenefits = ["Helps to collaborate more effectively", "Allows you to revert to old versions of the code"];
...
let stepsToPushChanges = ["1. You should add the file to stage the change using `git add <filename>` or git add .", "2. Use the command `git commit -m 'commit message' ` to create a commit message", "3. Finally use the command `git push` to push all commits to main"];
